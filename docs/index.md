...
!!! info "대상 및 환경"
    ...
    - **환경**: github.com 개인 레포 + 무료 러너로 전부 실행됩니다.
...
| [Lab 4](labs/lab4-secrets-security.md) | 4교시 | 시크릿 마스킹의 한계 / 외부 API 호출 / 권한 최소화 / (선택) 외부 저장소 업로드 |
| [Lab 5](labs/lab5-reuse-standardize.md) | 5교시 | reusable workflow·composite action·cache |
| [Lab 6](labs/lab6-runners-migration.md) | 6교시 | self-hosted 러너(선택, 클라우드 VM 포함)·Actions Importer로 Jenkins 변환·종합 실습 |
| [Lab 7](labs/lab7-migration-workshop.md) | 7교시 | 우리 파이프라인을 Actions로 — 전환 워크시트 |

## 시작하기

먼저 [환경 설정](00-setup.md)을 보고 **자기 실습 레포**를 하나 만드세요.
